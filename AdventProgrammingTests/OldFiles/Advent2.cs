...
class Advent2
{
    ...
    public string[] calcs = new string[] {
    "        20x3x11",
    "15x27x5",
    "6x29x7",
    "30x15x9",
    ...
    public void Start()
    {
        Console.WriteLine("Advent Challenge 2:  \n");

        //WrappingPaper
        foreach (var line in calcs)
        {
        ...
        Console.WriteLine("Advent 2 Part 1");
        ...
        Console.WriteLine("Advent 2 Part 2");
